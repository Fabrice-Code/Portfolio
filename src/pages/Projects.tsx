    ...
    <div className="block m-16 place-items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-3 hover:scale-110 hover:shadow-2xl gap-4">
      <div className="flex text-white align-items-center gap-8 mb-16">
        <button
          ...
          className={`px-3 py-2 rounded ${filter === "All" ? "bg-red-400 text-white" : ""}`}
        >
          Alle
        </button>
        <button
          onClick={() => setFilter("React")}
          className={`px-3 py-2 rounded ${filter === "React" ? "bg-blue-500 text-white" : ""}`}
        >
          React
        </button>
        <button
          onClick={() => setFilter("JavaScript")}
          className={`px-3 py-2 rounded ${filter === "JavaScript" ? "bg-green-500 text-white" : ""}`}
        >
          JavaScript
        </button>
      </div>
